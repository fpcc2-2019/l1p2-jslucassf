...
```
A _clickthrough rate_ diária é baixa com os dados analisados, em nenhum dos dias, este valor ultrapassa a marca de 50% das sessões. Em outras palavras, na maioria das sessões de busca, os usuários não clicam nos resultados apresentados.
...
Os valores de fato se alteram significantemente quando levamos os grupos em consideração. Os membros do grupo A clicam consideravelmente mais vezes do que os do grupo B, passando a marca dos 50% em todos os dias!